...
export async function GET() {
  return NextResponse.json({
    ...
    NEXT_PUBLIC_KEY_VAULTS_SECRET:
      process.env.NEXT_PUBLIC_KEY_VAULTS_SECRET ? 'set' : 'missing',

    NEXT_AUTH_SSO_PROVIDERS:
      process.env.NEXT_AUTH_SSO_PROVIDERS || null,
    ENABLE_OAUTH_SSO: process.env.ENABLE_OAUTH_SSO || null,
    NEXT_PUBLIC_ENABLE_NEXT_AUTH:
      process.env.NEXT_PUBLIC_ENABLE_NEXT_AUTH || null,
